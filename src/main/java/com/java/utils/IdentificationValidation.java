...
public class IdentificationValidation implements ComplexValidation {
	...
	private void validaCPF(String campo, String cpf) {
        ...
        if (!isOk) {	
            throw new UserLinkException(campo, "A identifica\u00e7\u00e3o do tipo CPF est\u00e1 inv\u00e1lido.");
        }
	...
	private void validaCNPJ(String campo, String cnpj) {
        ...
        if (!isOk) {
            throw new UserLinkException(campo, "A identifica\u00e7\u00e3o do tipo CNPJ est\u00e1 inv\u00e1lido.");
        }
